...
public class ModifyPartInhouseController implements Initializable {
    ...
    public void selectOutsourcedPart(ActionEvent event) throws IOException {
        ...
        // pass the event node and desired GUI filename into the changeScene mentod.
        sceneChanger.changeScene(outsourcedRadio, "ModifyPartOutsourced");
	...
	public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            newPart.setMachineID(((InhousePart)selectedPart).getMachineID());
            ...
            machineIDInput.setText(Integer.toString(newPart.getMachineID()));
